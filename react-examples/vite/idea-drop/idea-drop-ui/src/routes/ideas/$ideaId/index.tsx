...
export const Route = createFileRoute("/ideas/$ideaId/")({
  ...
  loader: async ({ params, context: { queryClient } }) => {
    return queryClient.ensureQueryData(ideaQueryOptions(params.ideaId)); //fetchIdea(params.ideaId);
  },
});
...
function IdeaDetailsPage() {
  ...
  return (
    <div className="p-4">
      ...
      <button disabled={isPending} onClick={handleDelete} className="text-sm bg-red-600 text-white mt-4 mr-2 px-4 py-2 rounded transition hover:bg-red-700 disabled:opacity-50">
