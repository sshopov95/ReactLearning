...
import clsx from 'clsx'; //Dynamic classes lib - easier to use

const IdeaCard = ({idea, button = true}:{idea:Idea, button?:boolean}) => {
    const linkClasses = clsx({
        'text-blue-600 hover:underline mt-3': !button,
        'text-center mt-4 inline-block bg-blue-600 text-white px-4 py-2 rounder hover:bg-blue-700 transition' : button
    }) 
    return ( 
