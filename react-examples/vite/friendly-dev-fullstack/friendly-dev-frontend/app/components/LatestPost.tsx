...
import type { LatestPostsData, PostMeta } from "~/types";

const LatestPosts = ({posts, limit = 3}:LatestPostsData) => {
    const sorted = [...posts].sort((a:PostMeta, b:PostMeta)=>{return new Date(b.date).getTime() - new Date(a.date).getTime()});
